...
const STATUS_BY_CODE: Record<string, number> = {
  ...
  PUBLIC_LINK_ACTIVE_CONFLICT: 409,
  TRANSACTION_NOT_FOUND_IN_SNAPSHOT: 404,
  QBO_ACCOUNT_ID_REQUIRED: 400,
  TXN_TYPE_NOT_SUPPORTED: 400,
  INTUIT_STALE_SYNC_TOKEN: 409,
  ...
  // 21-connections sharing (v0.10.0)
  CONNECTION_NOT_OWNER: 403,
  CONNECTION_SHARE_NOT_FOUND: 404,
  ...
  // 15-permissions RBAC (v0.15.0)
  ROLE_NOT_FOUND: 404,
  ROLE_NAME_CONFLICT: 409,
  SYSTEM_ROLE_NOT_EDITABLE: 403,
  PERMISSION_NOT_FOUND: 404,
  USER_ROLE_ALREADY_ASSIGNED: 409,
  USER_PERMISSION_OVERRIDE_EXISTS: 409,
  USER_MUST_HAVE_AT_LEAST_ONE_ROLE: 422,

  // 22-bank-worker (v0.16.0)
  BANK_PORTAL_NOT_FOUND: 404,
  BANK_PORTAL_ALREADY_EXISTS: 409,
  BANK_PORTAL_IN_USE: 409,
  CLIENT_BANK_ACCOUNT_NOT_FOUND: 404,
  CLIENT_BANK_ACCOUNT_ALREADY_EXISTS: 409,
  BANK_ACCOUNT_NOT_FOUND: 404,
  BANK_ACCOUNT_MASK_CONFLICT: 409,

  // 23-plugin-bridge (v0.17.0)
  ...
  // 22-bank-worker step-flow de descarga (v0.21.0)
  BANK_ADAPTER_NOT_SUPPORTED: 501,
  NO_BANK_ACCOUNTS_REGISTERED: 409,
  BANK_ACCOUNT_MASK_NOT_FOUND: 404,
  BANK_LOGIN_NOT_SUPPORTED: 501,
  BANK_SESSION_NOT_ESTABLISHED: 502,

  // 22-bank-worker orquestación de descarga (v0.27.0)
  DOWNLOAD_CLIENT_NOT_RESOLVED: 404,
  DOWNLOAD_CLIENT_AMBIGUOUS: 409,
  NO_DOWNLOADABLE_CREDENTIAL: 422,
  MULTIPLE_DOWNLOADABLE_CREDENTIALS: 409,
}
