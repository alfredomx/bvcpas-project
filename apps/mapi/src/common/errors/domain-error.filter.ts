...
const STATUS_BY_CODE: Record<string, number> = {
  ...
  // 21-microsoft-oauth (v0.6.2)
  MICROSOFT_TOKENS_NOT_FOUND: 404,
  MICROSOFT_REFRESH_EXPIRED: 401,
  MICROSOFT_STATE_INVALID: 400,
  MICROSOFT_AUTH_ERROR: 502,
  MICROSOFT_GRAPH_ERROR: 502,
}
