...
**Fixes:** [fix-rename-customer-support-tab.md](fix-rename-customer-support-tab.md), [fix-sync-bumps-status.md](fix-sync-bumps-status.md), [fix-followup-status-transitions.md](fix-followup-status-transitions.md)
