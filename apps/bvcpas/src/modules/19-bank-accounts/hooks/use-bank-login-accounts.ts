...
import { listBankAccounts, type BankAccountsListResponse } from '../api/bank-accounts.api'

export const BANK_LOGIN_ACCOUNTS_QUERY_KEY = 'bank-login-accounts'

export function useBankLoginAccounts(credentialId: string | null | undefined) {
