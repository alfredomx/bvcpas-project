 ...
 * que el plugin se montó y que su config propia se inyectó.
 */
@Controller('_example')
export class ExampleController {
  ...
  @Get('ping')
  ping(): { plugin: string; greeting: string } {
    return { plugin: '_example', greeting: this.config.EXAMPLE_GREETING }
  }
}
