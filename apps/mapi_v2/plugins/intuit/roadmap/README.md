...
- `27-client-reconnect` ✅ (intuit v0.8.0 — reconnect/disconnect por cliente + anti-mixup de realm en el reconnect). **Cerrado 2026-06-17**, tag `intuit-v0.8.0` · smoke reconnect 201 / disconnect 401·404.
...
| 27-client-reconnect | ✅     | [README.md](27-client-reconnect/README.md) | [v0.8.0](27-client-reconnect/v0.8.0.md) |
...
| 0.8.0   | 27-client-reconnect | ✅     | reconnect/disconnect por cliente               | intuit-v0.8.0 | [v0.8.0](27-client-reconnect/v0.8.0.md) |
...
| D-intuit-028 | Reconnect/disconnect **client-scoped** (`/clients/:clientId/{reconnect                                                                                                                | connection}`); anti-mixup: el state OAuth pasa a JSON `{clientId,expectedRealm}` y el callback exige misma compañía (`INTUIT_REALM_MISMATCH`) | 0.8.0   | —   |
